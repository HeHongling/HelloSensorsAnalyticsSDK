...
@interface CrossH5ViewController ()<UIScrollViewDelegate>
...
- (void)setupChildViewControllers {
    MyWKWebViewController *wkWebVC = [MyWKWebViewController new];
    wkWebVC.title = @"WKWebView";
    MyUIWebViewController *uiWebVC = [MyUIWebViewController new];
